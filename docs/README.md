...
## Prezentačný Web
V zložke `web/` sa nachádza prezentačná stránka projektu postavená na Next.js a Framer Motion. Slúži na vizuálnu demonštráciu fungovania senzora (Scrollytelling animácia) pre potenciálnych partnerov a komunitu. Pre jej spustenie prejdi do zložky a použi `npm run dev`.
